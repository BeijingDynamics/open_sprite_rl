...
def _resolve_g57_native_reference() -> str:
    override = os.environ.get("SPRITE0825_G57_EXPERT")
...
G57_NATIVE_REFERENCE = _resolve_g57_native_reference()


def _resolve_g72_g71_reference() -> str:
    override = os.environ.get("SPRITE0825_G72_EXPERT")
    repo_root = os.environ.get("SPRITE_RL_ROOT")
    candidates = [Path(override)] if override else []
    if repo_root:
        candidates.append(
            Path(repo_root)
            / "assets/references/stage2_amp/g72_g71_4340_shoulders_100hz_v1"
        )
    legacy = Path(
        "sprite/sprite_isaaclab/assets/sprite0825_references/stage2_amp/"
        "g72_g71_4340_shoulders_100hz_v1"
    )
    candidates.extend((Path("/home/tony") / legacy, Path("/root") / legacy))
    for candidate in candidates:
        if _is_accessible(candidate, directory=True):
...
G72_G71_REFERENCE = _resolve_g72_g71_reference()
...
class Sprite0825Stage2G57NativePM01UnconditionedAMPPPORunnerCfg(
    ...
    max_iterations = 80_000
    save_interval = 100
    dataset_path = G57_NATIVE_REFERENCE
...
@configclass
class Sprite0825Stage2G59Native50HzAMPPPORunnerCfg(
    Sprite0825Stage2G57NativePM01UnconditionedAMPPPORunnerCfg
):
    """Fresh 50 Hz deployment actor with a time-matched 100 Hz AMP expert."""

    experiment_name = "sprite0825_stage2_g59_native_50hz"
    run_name = "stage2_G59_native_50hz_scratch"
    max_iterations = 3_000
    save_interval = 100
    frame_length = 3
    expert_frame_stride = 2


@configclass
class Sprite0825Stage2G60TimeNormalizedWaist50HzAMPPPORunnerCfg(
    Sprite0825Stage2G59Native50HzAMPPPORunnerCfg
):
    """Low-rate continuation after correcting G59's 50 Hz regularization."""

    experiment_name = "sprite0825_stage2_g60_time_normalized_waist_50hz"
    run_name = "stage2_G60_time_normalized_waist_from_G59m2999"
    max_iterations = 600
    save_interval = 50
...
@configclass
class Sprite0825Stage2G61StartExposure50HzAMPPPORunnerCfg(
    Sprite0825Stage2G60TimeNormalizedWaist50HzAMPPPORunnerCfg
):
    """Low-rate G60 continuation with denser PM01 stand-to-walk command exposure."""

    experiment_name = "sprite0825_stage2_g61_start_exposure_50hz"
    run_name = "stage2_G61_start_exposure_from_G60m3450"
    max_iterations = 400
    save_interval = 50
...
@configclass
class Sprite0825Stage2G62TransitionExposure50HzAMPPPORunnerCfg(
    Sprite0825Stage2G61StartExposure50HzAMPPPORunnerCfg
):
    """Minimal G61 continuation with denser start/stop transition exposure."""

    experiment_name = "sprite0825_stage2_g62_transition_exposure_50hz"
    run_name = "stage2_G62_transition_exposure_from_G61m3600"
    max_iterations = 300
    save_interval = 25

    def __post_init__(self):
        super().__post_init__()
        self.algorithm.learning_rate = 1.0e-7


@configclass
class Sprite0825Stage2G72G71Expert4340Shoulders50HzAMPPPORunnerCfg(
    Sprite0825Stage2G59Native50HzAMPPPORunnerCfg
):
    """Fresh PM01 command actor using qualified G71 gait and v5 shoulder hardware."""

    experiment_name = "sprite0825_stage2_g72_g71_expert_4340_shoulders_50hz"
    run_name = "stage2_G72_g71_expert_4340_shoulders_scratch"
    dataset_path = G72_G71_REFERENCE
    max_iterations = 15_000
    save_interval = 250


@configclass
class Sprite0825Stage2G73ShoulderScaleFlatFeet50HzAMPPPORunnerCfg(
    Sprite0825Stage2G72G71Expert4340Shoulders50HzAMPPPORunnerCfg
):
    """Fresh G72-method actor with corrected shoulder semantics and flat-foot weight."""

    experiment_name = "sprite0825_stage2_g73_shoulder_scale_flatfeet_50hz"
    run_name = "stage2_G73_shoulder_scale_flatfeet_scratch"


@configclass
class Sprite0825Stage2G74ShoulderRollCenter50HzAMPPPORunnerCfg(
    Sprite0825Stage2G73ShoulderScaleFlatFeet50HzAMPPPORunnerCfg
):
    """Fresh G73-method actor with shoulder-roll centers aligned to the reference."""

    experiment_name = "sprite0825_stage2_g74_shoulder_roll_center_50hz"
    run_name = "stage2_G74_shoulder_roll_center_scratch"
