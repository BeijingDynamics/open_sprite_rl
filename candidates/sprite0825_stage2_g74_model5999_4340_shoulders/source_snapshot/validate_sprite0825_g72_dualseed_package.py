#!/usr/bin/env python3
"""Validate that a packaged G72 checkpoint owns complete dual-seed Isaac evidence."""
...
def validate(package: Path) -> dict:
    ...
    if manifest["schema"] != "sprite0825_g72_candidate_v1":
    ...
    return {
        "schema": "sprite0825_g72_dualseed_package_validation_v1",
        "qualified": True,
        "iteration": iteration,
...
def main() -> None:
    ...
    print(
        f'G72_DUALSEED_PACKAGE_OK model_{result["iteration"]}.pt '
