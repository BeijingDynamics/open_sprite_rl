...
def main(env_cfg, agent_cfg) -> None:
    ...
    contract = {
        ...
        "policy_jit_sha256": sha256(output_dir / "policy.pt"),
        ...
        "mujoco_joint_mapping": "explicit_name_to_qpos_and_dof_addresses",
        "mujoco_native_joint_order_may_differ": True,
        ...
        "physical_j4340p": {
            "motor_model": "DM-J4340P-2EC_at_approximately_38V",
            "joint_names": [
