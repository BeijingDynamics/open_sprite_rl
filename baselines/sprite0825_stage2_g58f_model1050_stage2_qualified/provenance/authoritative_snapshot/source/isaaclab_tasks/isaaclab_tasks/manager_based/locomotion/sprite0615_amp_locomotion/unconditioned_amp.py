...
from .unconditioned_amp_data import UnconditionedAMPDataLoader


class UnconditionedAMPPPO(AMPPPO):
    """PM01 AMP with a multi-clip expert distribution and persistent AMP state."""
    ...
    def construct_algorithm(obs: TensorDict, env: VecEnv, cfg: dict, device: str):
        ...
        cfg["algorithm"]["data_loader"] = UnconditionedAMPDataLoader(
            cfg["dataset_path"],
